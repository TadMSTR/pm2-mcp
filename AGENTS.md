...
- **No external dependencies beyond fastmcp** — PM2 is already installed globally on forge. No auth — this server is intended for localhost use only. See `docs/threat-model.md`.
